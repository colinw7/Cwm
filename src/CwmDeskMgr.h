...
class CwmDeskMgrNotifyData {
 ...
 public:
  CwmDeskMgrNotifyData(CwmDeskMgrNotifyType type, CwmDeskMgrNotifyProc proc,
                       CwmData data) :
 ...
 ~CwmDeskMgrNotifyData() { }
  ...
  bool match(CwmDeskMgrNotifyType type, CwmDeskMgrNotifyProc proc,
             CwmData data) {
...
class CwmDeskMgr {
  typedef list<CwmDeskMgrNotifyData *> DeskMgrNotifyDataList;
  typedef vector<CwmDesk *>            DeskList;
 ...
 ~CwmDeskMgr();
  ...
  void addNotifyProc(CwmDeskMgrNotifyType type,
                     CwmDeskMgrNotifyProc proc, void *data);
  void removeNotifyProc(CwmDeskMgrNotifyType type,
                        CwmDeskMgrNotifyProc proc, void *data);
